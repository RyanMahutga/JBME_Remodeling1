...
void solveJac(int num_nodes, int num_fibers, double x_scale, Matrix3d F, network& network0,
	...
	double fib_vol_m, double& WSS)
{
	double R0 = 600e-6, H0 = 100e-6, mu=0.003, Q=1.4e-6; // aorta radius and wall thickness unloaded and viscosity (Pa/s) and flow rate (m^3/s)
