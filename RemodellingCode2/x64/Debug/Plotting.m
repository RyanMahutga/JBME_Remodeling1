...
xlabel('Time [days]')
ylabel('Loaded Stretch, \lambda')
set(gca,'FontSize',16)

vol0 = stretch0(:,1).*stretch0(:,2).*stretch0(:,3);
%vol = vol./vol(480);
figure
plot(time,stretch0(:,1),'b-','LineWidth',2)
hold on
plot(time,stretch0(:,2),'g--','LineWidth',2)
plot(time,stretch0(:,3),'r:','LineWidth',2)
plot(time, vol0, 'k-', 'lineWidth',2)
legend('1-1 Stretch','2-2 Stretch','3-3 Stretch','V/V_0')
xlabel('Time [days]')
ylabel('Growth Stretch, \lambda^g')
set(gca,'FontSize',16)
